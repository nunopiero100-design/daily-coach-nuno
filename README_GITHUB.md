...
## Update v2 — OpenAI Structured Outputs

Esta versão usa `text.format` com `json_schema` na Responses API para forçar JSON válido na decisão do treinador.
Isto corrige erros do tipo:

```text
Erro OpenAI: Unterminated string ... usei regras heurísticas
```
